...
class IPos_Sync_Admin {
    ...
    public function render_admin_page() {
        ...
        <div class="wrap ocellaris-ipos-wrap">
                    ...
                    <svg xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 164.7 153" width="36" height="33" style="display:block">
                        ...
                        <g fill-rule="evenodd" fill="none" stroke-width="1" stroke="none" id="Page-1">
                            <g fill-rule="nonzero" transform="translate(-379.000000, -268.000000)" id="Artboard">
                                <g transform="translate(379.000000, 268.00000<0)" id="Logo-iPos-Full-Color">
            ...
            <p>Módulo de integración iPos para Wordpress/WooCommerce. Sincroniza productos, inventarios, clientes y órdenes entre ambas plataformas.</p>
            <?php
            $missing_options = empty($api_key) || empty($base_url);
            $woocommerce_inactive = !class_exists('WooCommerce');

            // caso 1: falta configuración (api key o base url o ambas)
            if ($missing_options): ?>
            <div class="notice notice-warning">
                <p><strong>Atención!</strong> Todavía no configuraste tu conexión con iPos.</p>
                <a href="<?php echo admin_url('admin.php?page=ipos-sync-settings'); ?>">
            ...
            <?php
            // caso 2: woocommerce no está activo
            if ($woocommerce_inactive): ?>
            <div class="notice notice-error">
                <p><strong>iPos Sync WP</strong> requiere <a href="https://woocommerce.com/" target="_blank" rel="noopener noreferrer">WooCommerce</a> para funcionar correctamente. Por favor, instala y activa el plugin WooCommerce e intenta nuevamente.</p>
            </div>
            <?php endif; ?>

            <?php
            // caso 3: todo ok, mostrar dashboard
            if (!$missing_options && !$woocommerce_inactive): ?>
